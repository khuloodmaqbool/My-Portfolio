              ...
              {skillSec1.map((crntele, index) => {
                return (
                  <>
                    <div
                      key={index}
                      className="flex relative px-3 w-4/5   py-5 sm:items-center "
                    >
                      <div className="flex-grow   flex sm:items-center items-start flex-col sm:flex-row">
                        ...
                        <div className="flex-grow w-full  sm:pl-6 mt-6 sm:mt-0">
                          <div className="flex justify-between">
                            <h2 className="font-medium title-font text-gray-900 mb-1 text-xl text-white">
                              {crntele.heading}
                            </h2>
                            <h2 className="font-medium title-font text-gray-900 mb-1 text-xl text-white">
                              {crntele.percent}
                          ...
                          <input
                            className={`w-full ${crntele.rangeClass}`}
                            type="range"
                            value={crntele.inpVal}
                          />
                        </div>
                      </div>
                    </div>
